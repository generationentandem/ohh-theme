			...
			<section class="tile-container" id="overview">
				...
				$events = und_get_events( array(
					...
					'tax_query'   => array(
						array(
							...
							'field'            => 'id',
							'terms'            => get_term_by( 'slug', 'programm', 'und_eventcat' )->term_id,
				...
				$listcategories = array(
					'friday'   => [
						...
						'maerit'     => 'Nachtflohmi&nbsp;&nbsp;<span class="text-muted">(17-22 Uhr)</span>',
					],
					'saturday' => [
						...
						'gym'     => 'Alte Turnhalle&nbsp;&nbsp;<span class="text-muted">(bis 2 Uhr)</span>',
					]
				);
