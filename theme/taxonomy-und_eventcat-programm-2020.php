		...
		<div id="generationenfestival-2019">
			<header class="generationenfestival-2019-header" role="banner">
				...
				<section class="highlights">
					<h2>4. &amp; 5. September&nbsp;2020 (verschoben)</h2>
...
/*						echo $days;
		...
		<div class="wrapper festival-2019-main">
			...
			<section class="tile-container" id="overview">
				<h2 class="title-tile f19_heading">Events</h2>
				...
				$events = und_get_events( array(
					...
					'tax_query'   => array(
						array(
							...
							'field'            => 'id',
							'terms'            => get_term_by( 'slug', 'programm-2020', 'und_eventcat' )->term_id,
				...
				$listcategories = array(
					'friday'   => [
						'programm' => 'Programm',
						'food'     => 'Food <span class="text-muted">(bis 1 Uhr)</span>',
					],
					'saturday' => [
						'stage'    => 'Bühne <span class="text-muted">(bis 2 Uhr)</span>',
						'workshop' => 'Workshops <span class="text-muted">(bis 18 Uhr)</span>',
						'market'   => 'Märit <span class="text-muted">(bis 18 Uhr)</span>',
						'food'     => 'Food <span class="text-muted">(bis 2 Uhr)</span>',
					]
				);
					...
					<div class="f19_timetable  grid-x">
						<section class="cell f19_timetable-box">
							<h3 class="f19_heading f19_timetable-heading">
								...
								} ?>Freitag, 4. Sept <span class="text-muted">(ab 18 Uhr)</span>
							</h3>
							<div class="grid-x">
								<?php
						...
						<section class="cell ">
							<h3 class="f19_heading f19_timetable-heading">
								...
								} ?>Samstag, 5. Sept <span class="text-muted">(ab 10 Uhr)</span>
							</h3>
							<div class="grid-x">
								<?php
